    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-sm relative">
        <div className="flex flex-col items-center mb-8 animate-fade-slide-up">
          ...
          <h1 className="text-xl font-bold text-text-primary tracking-tight">{t('auth.register')}</h1>
        ...
        <div className="glass rounded-2xl border border-border shadow-glass-lg p-6 animate-scale-fade-in stagger-1">
          <form onSubmit={onSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold text-text-secondary mb-1.5">{t('auth.username')}</label>
              <input
                value={username}
            ...
            <div>
              <label className="block text-xs font-semibold text-text-secondary mb-1.5">{t('auth.password')}</label>
            ...
            <div className="flex items-center justify-between pt-1">
              ...
              <Link to="/login" className="text-xs text-accent hover:text-accent/80 font-medium transition-colors">
                {t('auth.hasAccount')}
              </Link>
            </div>
          </form>
